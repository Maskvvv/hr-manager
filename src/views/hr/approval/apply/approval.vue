...
<!--    </el-row>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="失败理由" prop="reasonFailure" v-if="form.aprrovalState == 0">
          <el-input v-model="form.reasonFailure" placeholder="请输入失败理由" />
        </el-form-item>
      </el-form>
...
<script>
import { listApproval, getApply, delApply, addApply, updateApply, exportApply } from "@/api/hr/approval/apply";
